...
namespace RugratsWebApp.Controllers
{
    ...
    public class AccountController : Controller
	{
        ...
        [HttpGet]
        public async System.Threading.Tasks.Task<ActionResult> ShortCuts()
        {
            if (string.IsNullOrEmpty(User.Identity.Name))
            {
                return RedirectToAction("Index", "Login");
        ...
        [HttpGet]
	    public async System.Threading.Tasks.Task<ActionResult> MoneyWithdraw(string AccountNo)
        {
            if (string.IsNullOrEmpty(User.Identity.Name))
            {
                return RedirectToAction("Index", "Login");
            ...
            using (var client = new HttpClient())
            {
                ...
                var task = client.GetAsync("https://localhost:44329/api/account/getaccountbyid/" + AccountNo)
                  .ContinueWith((taskwithresponse) =>
                  {
                      var response = taskwithresponse.Result;
                      var jsonString = response.Content.ReadAsStringAsync();
        ...
        [HttpPost]
        public async System.Threading.Tasks.Task<ActionResult> MoneyWithdrawAsync(withDrawMoneyModel collection)
        {
            try
            {
                // TODO: Add insert logic here
        ...
        [HttpGet]
        public async System.Threading.Tasks.Task<ActionResult> DepositMoney(string AccountNo)
        {
            if (string.IsNullOrEmpty(User.Identity.Name))
            {
                return RedirectToAction("Index", "Login");
        ...
        [HttpPost]
        public async System.Threading.Tasks.Task<ActionResult> DepositMoney(withDrawMoneyModel collection)
        {
            try
            {
                // TODO: Add insert logic here
